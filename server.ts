...
app.use((req, res, next) => {
  ...
  const csp = [
    ...
    "frame-src 'self' https: data: blob: https://*.firebaseapp.com https://accounts.google.com https://*.google.com https://apis.google.com https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://*.googlesyndication.com https://www.highrevenueformat.com https://*.highrevenueformat.com https://yandex.ru https://*.yandex.ru https://*.yandex.net",
