/**
 * Utility for masking sensitive user credentials (email, UID, phone, IP)
 * to guarantee 100% privacy and confidentiality across the platform.
 * e.g. "gavharoy@gmail.com" -> "ga***y@gmail.com"
 * e.g. "usr_1234567890abcdef" -> "usr_***cdef"
 */
