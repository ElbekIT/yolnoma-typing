...
class SpaceSoundEngine {
  ...
  /**
   * Dushman o'q uzganda tovush (Enemy plasma blast)
   */
  ...
  /**
   * O'yinchi kemasiga o'q tekkanda zarba tovushi (Player Hit / Shield Impact)
   */
  ...
  /**
   * Dushmanning qalqoni (Shield) singanda tovush
   */
